...
cap = cv2.VideoCapture("squats/squats.mp4")
prv_state = -1
state = "ZZ"
meassage = None
count = 0
...
if os.path.isfile("./squats/squats.csv"):
    f = open('./squats/squats.csv', 'a', encoding='UTF8')
    writer = csv.writer(f)

else:
    f = open('squats/squats.csv', 'w', encoding='UTF8')
    writer = csv.writer(f)
